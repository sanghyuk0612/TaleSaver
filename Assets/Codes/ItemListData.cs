...
public class ItemListData
{
    public static List<ItemList> items = new List<ItemList>
    {
        ...
        new ItemList(2, "롱소드", 2100, "공격 데미지 15% 추가"),              // Long Sword  1
        new ItemList(3, "너클", 1800, "치명타 확률 5% 증가"),                 // Knuckle    
        new ItemList(4, "플레이트 갑옷", 2400, "받는 데미지 15% 감소"),        // Plate Armor  
        new ItemList(5, "덤벨", 1650, "최대 체력 현재 체력의 15% 증가"),        // Dumbbell    1
        new ItemList(6, "주사위", 900, "처치 시 재료 드랍 확률 5% 증가"),      // Dice
        new ItemList(7, "얼음 장화", 1350, "이동 속도 15% 증가"),             // Ice Boots     1
        new ItemList(8, "고급 기름", 600, "체력 25% 회복 (소모품)"),         // Premium Oil
        new ItemList(9, "윤활유", 1050, "공속 10% 증가"),                     // Lubricant
        new ItemList(10, "쉴드", 2250, "공격 1회 무효"),                      // Shield      
        new ItemList(11, "피닉스(고오급)", 100, "죽을 시 25% 체력으로 자동 부활 (1회)"), // Phoenix HighGrade   1 (부활 확인하기 위해 가격 인하)
        ...
        new ItemList(18, "작은 날개", 999, "점프력 증가")   // small wing                                1      
    };
