...
public class ItemListData
{
    public static List<ItemList> items = new List<ItemList>
    {
        ...
        new ItemList(2, "롱소드", 700, "공격 데미지 15% 추가"),              // Long Sword  1
        new ItemList(3, "너클", 600, "치명타 확률 5% 증가"),                 // Knuckle    
        new ItemList(4, "플레이트 갑옷", 800, "받는 데미지 15% 감소"),        // Plate Armor  
        new ItemList(5, "덤벨", 550, "최대 체력 현재 체력의 15% 증가"),        // Dumbbell    1
        new ItemList(6, "주사위", 300, "처치 시 재료 드랍 확률 5% 증가"),      // Dice
        new ItemList(7, "얼음 장화", 450, "이동 속도 15% 증가"),             // Ice Boots     1
        ...
        new ItemList(11, "피닉스(고오급)", 1000, "죽을 시 25% 체력으로 자동 부활 (1회)"), // Phoenix HighGrade   1
        ...
        new ItemList(18, "작은 날개", 333, "점프력 증가")   // small wing                                1      
    };
